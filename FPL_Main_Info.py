...
st.dataframe(
    ...
    column_config={
        ...
        "Play Pos": st.column_config.TextColumn("Pl Pos", width=50),
        "team_short_name": st.column_config.TextColumn("Team", width=50),
        ...
        "avg_mins": st.column_config.NumberColumn("AvgM", width=45, format="%d"),
        ...
        "av_rating": st.column_config.NumberColumn("Rt", width=45, format="%.2f"),
