...
st.set_page_config(
    page_title="LaLiga2 Team Strength",
    layout="wide",
...
KNOWN_TEAM_COLORS_AND_CODES = {
    "AD Ceuta": ("CEU", "#222222", "#FFFFFF"),
    "AFC Wimbledon": ("WIM", "#003F96", "#00439f"),
    "Accrington": ("ACC", "#AE001B", "#AE001B"),
    "Alaves": ("ALA", "#005BBB", "#005BBB"),
    "Albacete": ("ALB", "#111111", "#FFFFFF"),
    "Alcorcon": ("ALC", "#FEE000", "#FEE000"),
    "Aldershot": ("ALD", "#C8102E", "#C8102E"),
    "Almeria": ("ALM", "#E41B13", "#E41B13"),
    "Altrincham": ("ALT", "#C8102E", "#C8102E"),
    "Amorebieta": ("AMO", "#003366", "#004080"),
    "Andorra": ("AND", "#ED1C24", "#ED1C24"),
    "Arsenal": ("ARS", "#bd0510", "#bd0510"),
    "Aston Villa": ("AVL", "#7D1142", "#9d2358"),
    ...
    "Barnet": ("BAR", "#F57E20", "#F57E20"),
    "Barnsley": ("BAR", "#E1052E", "#E1052E"),
    "Barrow": ("BRW", "#005BAA", "#005BAA"),
    "Betis": ("BET", "#0BB364", "#0BB364"),
    "Birmingham": ("BIR", "#0032A0", "#0053bb"),
    "Blackburn": ("BLB", "#005E9C", "#005E9C"),
    "Blackpool": ("BLP", "#d53e00", "#f76100"),
    "Bolton": ("BOL", "#313453", "#ffffff"),
    "Boreham Wood": ("BOR", "#111111", "#FFFFFF"),
    "Bournemouth": ("BOU", "#D71921", "#D71921"),
    "Bradford City": ("BRA", "#711F2B", "#f7a30a"),
    "Brentford": ("BRE", "#C00808", "#C00808"),
    "Brighton": ("BHA", "#0850A0", "#095bb6"),
    "Bristol City": ("BCI", "#E01A24", "#E01A24"),
    "Bristol Rovers": ("BRO", "#206BBE", "#206BBE"),
    "Bromley": ("BRM", "#111111", "#FFFFFF"),
    "Burgos CF": ("BUR", "#111111", "#FFFFFF"),
    "Burnley": ("BUR", "#5E1444", "#813868"),
    "Burton": ("BUT", "#000000", "#eee427"),
    "Bury FC": ("BRY", "#203058", "#203058"),
    "CF Fuenlabrada": ("FUE", "#004B9B", "#004B9B"),
    "Cadiz": ("CAD", "#FBD000", "#FEE135"),
    "Cadiz CF": ("CAD", "#FBD000", "#FEE135"),
    "Cambridge Utd": ("CAM", "#d47b00", "#d47b00"),
    "Cardiff": ("CAR", "#005CAA", "#005CAA"),
    "Carlisle": ("CRL", "#4878B0", "#4878B0"),
    "Castellon": ("CAS", "#111111", "#FFFFFF"),
    "Celta Vigo": ("CEL", "#8AC3EE", "#8AC3EE"),
    "Celta Vigo B": ("CLB", "#8AC3EE", "#8AC3EE"),
    "Ceuta": ("CEU", "#222222", "#FFFFFF"),
    "Charlton": ("CHA", "#D00820", "#D00820"),
    "Chelsea": ("CHE", "#051495", "#033cc1"),
    "Cheltenham": ("CHL", "#EC3B4C", "#EC3B4C"),
    "Chesterfield": ("CHS", "#004990", "#1e549d"),
    "Colchester": ("COL", "#1E4C93", "#1E4C93"),
    "Cordoba": ("COR", "#008754", "#008754"),
    "Coventry": ("COV", "#65b0e4", "#6bb5ea"),
    "Crawley Town": ("CRA", "#BA201F", "#BA201F"),
    "Crewe": ("CRE", "#aa3622", "#c83f26"),
    "Crystal Palace": ("CRY", "#0055A5", "#0055A5"),
    "Cultural Leonesa": ("LEO", "#990000", "#990000"),
    "Dagenham & Red.": ("DAG", "#ED241B", "#ED241B"),
    "Dep. A Coruna": ("DEP", "#005CA9", "#005CA9"),
    "Derby": ("DER", "#201E1F", "#ffffff"),
    "Doncaster": ("DON", "#CE1C40", "#CE1C40"),
    "Eastleigh": ("EAS", "#005BAA", "#005BAA"),
    "Eibar": ("EIB", "#941B26", "#004D98"),
    "Elche": ("ELC", "#007A33", "#007A33"),
    "Eldense": ("ELD", "#0A3A82", "#8E1F2F"),
    "Espanyol": ("ESP", "#007FC8", "#007FC8"),
    "Everton": ("EVE", "#00359C", "#0051d6"),
    "Exeter": ("EXE", "#AB0819", "#AB0819"),
    "Extremadura UD": ("EXT", "#8E1F2F", "#003366"),
    "FC Andorra": ("AND", "#ED1C24", "#ED1C24"),
    "FC Cartagena SAD": ("CAR", "#111111", "#FFFFFF"),
    "Fleetwood Town": ("FLE", "#C80808", "#C80808"),
    "Forest Green": ("FGR", "#65bb00", "#adff2f"),
    "Fuenlabrada": ("FUE", "#004B9B", "#004B9B"),
    "Fulham": ("FUL", "#000000", "#ffffff"),
    "Gateshead": ("GAT", "#111111", "#FFFFFF"),
    "Getafe": ("GET", "#00509E", "#00509E"),
    "Gijon": ("GIJ", "#E30613", "#E30613"),
    "Gillingham": ("GIL", "#0768C7", "#0768C7"),
    "Gimnastic": ("GIM", "#D31126", "#D31126"),
    "Gimnastic de Tarragona": ("GIM", "#D31126", "#D31126"),
    "Girona": ("GIR", "#CD2027", "#CD2027"),
    "Granada CF": ("GRA", "#C8102E", "#C8102E"),
    "Grimsby": ("GRI", "#111111", "#FFFFFF"),
    "Guadalajara": ("GUA", "#660099", "#660099"),
    "Halifax": ("HFX", "#005BAA", "#005BAA"),
    "Harrogate": ("HGT", "#FDB913", "#FDB913"),
    "Hartlepool": ("HAR", "#2B3068", "#3c46b4"),
    "Hercules": ("HER", "#003399", "#003399"),
    "Huddersfield": ("HUD", "#0072CE", "#0072CE"),
    "Huesca": ("HUE", "#003366", "#A6192E"),
    "Hull City": ("HUL", "#ED8B00", "#fd9416"),
    "Ipswich": ("IPS", "#0333A0", "#004fc2"),
    "Jaen": ("JAE", "#660099", "#660099"),
    "Las Palmas": ("LPA", "#F4B400", "#FFE033"),
    "Leeds": ("LEE", "#0060AA", "#ffffff"),
    "Leganes": ("LEG", "#0055A5", "#0055A5"),
    "Leicester": ("LEI", "#0d47a1", "#0f55bd"),
    "Leonesa": ("LEO", "#990000", "#990000"),
    "Levante": ("LEV", "#8E1F2F", "#004B87"),
    "Leyton Orient": ("LEY", "#CC1F25", "#CC1F25"),
    "Lincoln City": ("LIN", "#F80000", "#F80000"),
    "Liverpool": ("LIV", "#911712", "#911712"),
    "Lorca FC": ("LOR", "#003366", "#003366"),
    "Lugo": ("LUG", "#C8102E", "#C8102E"),
    "Luton": ("LUT", "#FA4616", "#FA4616"),
    "Malaga": ("MAL", "#5FA8E0", "#5FA8E0"),
    "Mallorca": ("MLL", "#E20613", "#E20613"),
    "Manchester City": ("MCI", "#69A8D8", "#76b4e5"),
    "Manchester United": ("MUN", "#C70101", "#C70101"),
    "Mansfield": ("MAN", "#284888", "#EDB12E"),
    "Middlesbrough": ("MID", "#D5002E", "#D5002E"),
    "Millwall": ("MIL", "#003078", "#0b4299"),
    "Milton Keynes Dons": ("MKD", "#b8a565", "#ffffff"),
    "Mirandes": ("MIR", "#DE0028", "#DE0028"),
    "Morecambe": ("MOR", "#902828", "#902828"),
    "Murcia": ("MUR", "#C8102E", "#C8102E"),
    "Newcastle Utd": ("NEW", "#141413", "#ffffff"),
    "Newport": ("NPT", "#F57E20", "#F57E20"),
    "Northampton": ("NOR", "#782040", "#9e2a54"),
    "Norwich": ("NOR", "#038C40", "#038C40"),
    "Nottingham": ("NFO", "#C8102E", "#C8102E"),
    "Notts County": ("NCO", "#14120b", "#ffffff"),
    "Numancia": ("NUM", "#DE0028", "#DE0028"),
    "Oldham": ("OLD", "#014898", "#014898"),
    "Osasuna": ("OSA", "#D91A2A", "#D91A2A"),
    "Oviedo": ("OVI", "#003882", "#003882"),
    "Oxford Utd": ("OXF", "#2b4790", "#00599d"),
    "Peterborough": ("PET", "#3679c3", "#3679c3"),
    "Plymouth": ("PLY", "#102218", "#00654f"),
    "Ponferradina": ("PON", "#00509E", "#00509E"),
    "Port Vale": ("PVL", "#000000", "#FFFFFF"),
    "Portsmouth": ("POR", "#0056A1", "#0056A1"),
    "Preston": ("PNE", "#001850", "#1c549c"),
    "QPR": ("QPR", "#0054A4", "#0054A4"),
    ...
    "Reus FCR": ("REU", "#DE0028", "#DE0028"),
    "Rochdale": ("ROC", "#004890", "#004890"),
    "Rotherham": ("ROT", "#EF4135", "#EF4135"),
    "Sabadell": ("SAB", "#005BAA", "#005BAA"),
    "Salford": ("SAL", "#BA0C2F", "#BA0C2F"),
    "Scunthorpe": ("SCU", "#00A8D8", "#00A8D8"),
    "Sevilla": ("SEV", "#D4001F", "#D4001F"),
    "Sevilla B": ("SVB", "#D4001F", "#D4001F"),
    "Sevilla FC B": ("SVB", "#D4001F", "#D4001F"),
    "Sheffield Utd": ("SHU", "#E30613", "#E30613"),
    "Sheffield Wed": ("SHW", "#4685C3", "#4685C3"),
    "Shrewsbury": ("SHR", "#4379C3", "#4379C3"),
    "Solihull Moors": ("SOL", "#FDB913", "#FDB913"),
    "Som Maresme": ("SMM", "#005BAA", "#005BAA"),
    "Southampton": ("SOU", "#d71920", "#d71920"),
    "Southend": ("SOU", "#123259", "#1f5595"),
    "Stevenage": ("STE", "#BC1C1C", "#BC1C1C"),
    "Stockport County": ("STP", "#0058D6", "#0058D6"),
    "Stoke City": ("STK", "#D7172F", "#D7172F"),
    "Sunderland": ("SUN", "#DC0814", "#DC0814"),
    "Sutton": ("SUT", "#FDB913", "#FDB913"),
    "Swansea": ("SWA", "#000000", "#FFFFFF"),
    "Swindon": ("SWI", "#C70319", "#C70319"),
    "Tenerife": ("TEN", "#0055A5", "#0055A5"),
    "Torquay": ("TRQ", "#FDB913", "#FDB913"),
    "Tottenham": ("TOT", "#132257", "#ffffff"),
    "Tranmere": ("TRA", "#004898", "#ffffff    "),
    ...
    "Walsall": ("WAL", "#B01820", "#B01820"),
    "Watford": ("WAT", "#d99f00", "#FBEE23"),
    "West Brom": ("WBA", "#002F68", "#1d549d"),
    "West Ham": ("WHU", "#7B2B3A", "#8B3249"),
    "Wigan": ("WIG", "#0033A0", "#FFFFFF"),
    "Woking": ("WOK", "#C8102E", "#C8102E"),
    "Wolves": ("WOL", "#FBA71B", "#FBA71B"),
    "Wrexham": ("WRE", "#E5131C", "#E5131C"),
    "Wycombe": ("WYC", "#083868", "#72A4EA"),
    "Xerez CD": ("XER", "#003399", "#003399"),
    "Yeovil": ("YEO", "#419901", "#4CAE21"),
    "York City": ("YRK", "#C8102E", "#C8102E"),
    "Zaragoza": ("ZAR", "#005BAA", "#005BAA"),
}

def apply_team_code_and_color_fallbacks(df):
    import os
    team_dict = {}
    ...
    code_map = {t: info['abbr'] for t, info in team_dict.items()} if team_dict else {}
    light_map = {t: info.get('color_light', '#888888') for t, info in team_dict.items()} if team_dict else {}
    dark_map = {t: info.get('color_dark', '#888888') for t, info in team_dict.items()} if team_dict else {}

    for t, info in KNOWN_TEAM_COLORS_AND_CODES.items():
...
def apply_team_code_and_color_fallbacks(df):
    ...
    team_dict = {}
    for p in [
        os.path.join(os.path.dirname(__file__), '..', 'team_colors.json'),
        os.path.join(os.path.dirname(__file__), '..', '..', 'streamlit', 'team_colors.json'),
        os.path.join(os.path.dirname(__file__), '..', '..', 'Team Strength Model', 'team_colors.json'),
    ]:
        if os.path.exists(p):
            try:
                with open(p, 'r', encoding='utf-8') as f:
...
def load_data():
    ...
    try:
        ...
        import os
        local_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "..", "streamlit", "team_strength_model_v2.parquet")
        if os.path.exists(local_path):
            df = pd.read_parquet(local_path)
        else:
            raise

    df = apply_team_code_and_color_fallbacks(df)
    ...
    try:
        ...
        if meta_resp.status_code == 200:
            ...
            div_data = divisions.get("Spain__LaLiga2__2", {})
    ...
    if not last_update_str and 'match_date' in df.columns:
        played = df[(df['league'] == "LaLiga2")].dropna(subset=['match_result'])
        if not played.empty:
...
ll2_teams_all = df[df['league'] == 'LaLiga2']
for _, row in ll2_teams_all[['home_team_code', 'home_team']].dropna().drop_duplicates().iterrows():
    team_code_to_name[row['home_team_code']] = row['home_team']
for _, row in ll2_teams_all[['away_team_code', 'away_team']].dropna().drop_duplicates().iterrows():
...
all_seasons = sorted([s for s in df[df['league'] == 'LaLiga2']['season'].dropna().unique() if s != "2009/10"])
...
ll2_df_filtered = df[(df['league'] == 'LaLiga2') & (df['season'] >= s_start) & (df['season'] <= s_end)]
all_teams = sorted([t for t in set(ll2_df_filtered['home_team_code'].dropna()).union(set(ll2_df_filtered['away_team_code'].dropna())) if t and str(t).strip()])

if 'ts_ll2_pills_teams' not in st.session_state or st.session_state.get('ts_ll2_prev_all_teams') != all_teams:
    st.session_state.ts_ll2_pills_teams = all_teams
    st.session_state.ts_ll2_prev_all_teams = all_teams

search_name = st.sidebar.text_input("Search Team", placeholder="Enter team name...", key="ts_ll2_search_name")
...
filter_header("Teams", all_teams, "ll2_pills_teams")
selected_teams = st.sidebar.pills(
    "Teams", options=all_teams, key="ts_ll2_pills_teams",
...
with col1:
    ...
    curr_season_df = df[(df['league'] == 'LaLiga2') & (df['season'] == current_season)]
...
df_hist = df_hist[df_hist['league'] == 'LaLiga2']
