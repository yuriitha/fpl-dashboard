...
all_seasons = sorted([s for s in df[df['league'] == 'LaLiga2']['season'].dropna().unique() if s >= "2010/11"])
...
with col1:
    ...
    df_played = df[(df['league'] == 'LaLiga2')].dropna(subset=['match_result'])
    ...
    df_unplayed = df[(df['league'] == 'LaLiga2') & (df['match_result'].isna())]
