...
st.dataframe(
    ...
    column_config={
        ...
        "Team Name": st.column_config.TextColumn("Team Name", width=120),
        "Price": st.column_config.NumberColumn("Price", width=45, format="%.1f"),
        "TM Value": st.column_config.TextColumn("TM Value", width=60),
        "Selected": st.column_config.NumberColumn("Sel %", width=50, format="%.1f"),
        "Top 1K": st.column_config.NumberColumn("T1K", width=45, format="%.1f"),
        "Top 5K": st.column_config.NumberColumn("T5K", width=45, format="%.1f"),
        "Mins": st.column_config.NumberColumn("Min", width=45),
        "PPM": st.column_config.NumberColumn("PPM", width=45, format="%.1f"),
