...
cost_range = st.sidebar.slider("Ціна (£m)", min_value=min_cost, max_value=max_cost, value=(min_cost, max_cost), step=0.1)
...
fig = px.scatter(
    ...
    hover_data=["team_short_name", "G_90", "xG_90", "xGI_90"],
    title="xGI_norm vs Avg Rating Alt (всі гравці)",
    labels={
        "av_rating_alt": "Avg Rating Alt (весь сезон)",
        "xGI_norm": "xGI_norm (нормований)",
...
st.subheader("Статистика по відфільтрованих гравцях")
st.dataframe(
    plot_df[["full_name", "team_short_name", "element_type", "now_cost", 
             "av_rating_alt", "xGI_norm", "xGI_90", "xG_90", "G_90"]].round(2),
